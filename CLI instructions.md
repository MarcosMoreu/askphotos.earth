...
3. **Prepare Your Links:** Create a text file in the same folder named `links.txt`. Paste the Google Photos shared albums URLs inside it. The script will exclude any text inside the file except these URLs
...
1. download	Include this flag if you want to save local compressed copies of the photos.
2. quality	Set the image compression quality from 1-100 (70 is recommended).
3. key	Your Google Gemini API Key. Get one for free at AI Studio.
